...
export default function College0({ navigation }) {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => navigation.navigate("College3", {
    degree: "All Colleges",
  })}
          >
            <Ionicons name="business" size={40} color="#0B5ED7" />
            <Text style={styles.gridTitle}>View Colleges</Text>
            <Text style={styles.gridSub}>Explore Colleges for you </Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.gridTitle}>View Courses</Text>
