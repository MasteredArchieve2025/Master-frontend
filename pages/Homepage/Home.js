  ...
  <View style={styles.bannerWrapper}>
    ...
    >
      <View style={styles.textContainer}>
        <Text style={styles.bannertitle}>Unlock Your Future at</Text>
        <Text style={styles.bannerSubtitle}>ARUNACHALA COLLEGE OF </Text>
        <Text style={styles.bannerSubtitle}>ENGINEERING</Text>
        <Text style={styles.bannerInfo}>Admissions Open for 2025-2026</Text>
      </View>
      <Image source={collegeBannerImage} style={styles.bannerImage} />
    </LinearGradient>
  </View>
);
...
////////////////////////////////////////
const choices = [
  { id: 1, title: "School", icon: <MaterialCommunityIcons name="school" size={28} color="#1a73e8" /> },
  { id: 2, title: "College", icon: <FontAwesome5 name="graduation-cap" size={26} color="#1a73e8" /> },
  { id: 3, title: "Course", icon: <FontAwesome5 name="laptop" size={26} color="#1a73e8" /> },
  { id: 4, title: "Exam", icon: <MaterialCommunityIcons name="file-document-edit-outline" size={28} color="#1a73e8" /> },
  { id: 5, title: "IQ", icon: <MaterialCommunityIcons name="head-cog-outline" size={28} color="#1a73e8" /> },
  { id: 6, title: "Extra-Skills", icon: <MaterialCommunityIcons name="music-note" size={26} color="#1a73e8" /> },
];
  ...
  return (
    <View style={styles.choiceRow}>
      ...
      >
        ...
        <Text numberOfLines={1} style={styles.choiceTitle}>{item.title}</Text>
        <View style={styles.sideSlot}>{isEven ? item.icon : null}</View>
      </TouchableOpacity>
    </View>
  );
...
////////////////////////////////////////
const COURSES_DATA = [
  { id: "1", title: "Web Development", duration: "3 to 6 Months", rating: 4.0, image: "https://picsum.photos/seed/picsum1/300/200" },
  { id: "2", title: "UI/UX Design", duration: "3 to 6 Months", rating: 4.0, image: "https://picsum.photos/seed/picsum2/300/200" },
  { id: "3", title: "Full Stack", duration: "3 to 6 Months", rating: 4.0, image: "https://picsum.photos/seed/picsum3/300/200" },
  { id: "4", title: "Data Analytics", duration: "3 to 6 Months", rating: 4.0, image: "https://picsum.photos/seed/picsum4/300/200" },
  { id: "5", title: "DevOps", duration: "2 to 4 Months", rating: 4.5, image: "https://picsum.photos/seed/picsum5/300/200" },
  { id: "6", title: "Machine Learning", duration: "6 to 12 Months", rating: 4.8, image: "https://picsum.photos/seed/picsum6/300/200" },
];
  ...
  <View style={styles.courseCard}>
    ...
    <View style={styles.cardContent}>
      ...
      <View style={styles.ratingContainer}>
        <Text style={styles.ratingText}>{'★'.repeat(Math.floor(course.rating))}</Text>
        <Text style={styles.ratingText}>{'☆'.repeat(5 - Math.floor(course.rating))}</Text>
...
////////////////////////////////////////
const tutorialsData = [
  { id: "1", title: "Canva Graphic Design", subtitle: "Course - Beginner", duration: "2h 30m", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" },
  { id: "2", title: "Canva Graphic Design", subtitle: "Course - Beginner", duration: "2h 30m", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4" },
  { id: "3", title: "Canva Graphic Design", subtitle: "Course - Beginner", duration: "2h 30m", videoUrl: "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4" },
];
...
const LeftIconsCollege = () => (
  <View style={{ flexDirection: "row", alignItems: "center", width: 70, marginRight: 12 }}>
...
const TopRateColleges = () => {
  ...
  const renderCollegeList = (data) => (
    <FlatList
      ...
      renderItem={({ item }) => <ListItemFull rank={item.id} name={item.name} />}
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.section}>
          ...
          {choices.map((c, i) => (
            <ChoiceItemRibbon key={c.id} item={c} index={i} navigation={navigation} />
          ))}
        </View>
        ...
        <View style={styles.section}>
          ...
          {COURSES_DATA.length > 4 && (
            <View style={styles.moreButtonContainer}>
              ...
              >
                <Text style={styles.moreButtonText}>{showAll ? "Less" : "More"}</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
